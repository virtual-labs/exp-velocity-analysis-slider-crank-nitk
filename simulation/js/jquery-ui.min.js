...
//               (r.range === !0 &&
//                 (r.values
//                   ? r.values.length && r.values.length !== 2
//                     ? (r.values = [r.values[0], r.values[0]])
//                     : e.isArray(r.values) && (r.values = r.values.slice(0))
//                   : (r.values = [this._valueMin(), this._valueMin()])),
